...
//        01
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.img_1), contentDescription = "Basics of Wood Carving",
                    modifier = Modifier
                        .height(150.dp)
...
//        02
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.img_2), contentDescription = "An Introduction to Oil Painting",
                    modifier = Modifier
                        .height(150.dp)
...
//        03
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.img_3), contentDescription = "Indian Architecture",
                    modifier = Modifier
                        .height(150.dp)
                        .scale(scaleX = 1.2F, scaleY = 1F)
                )
...
//        04
        ...
        )
        {
            Column(
                ...
                Image(
                    painterResource(id = R.drawable.img_4), contentDescription = "Branding in Marketing",
                    modifier = Modifier
                        .height(150.dp)
                        .scale(scaleX = 1.2F, scaleY = 1F)
                )
